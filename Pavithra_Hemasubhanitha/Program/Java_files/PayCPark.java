...
public class PayCPark extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i3x1 = getIntent();
 		...
 		// Toast.makeText(PayCPark.this,"City" + City,Toast.LENGTH_LONG).show();
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
     			...
     			if(!alert.trim().equals("")){
     				Toast.makeText(PayCPark.this,""+alert,Toast.LENGTH_LONG).show();     
     	        }
     			else
     			{	
        ...
        Back.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    Intent a=new Intent(PayCPark.this,UserMain.class);
...
public int incID(){    
	...
	Cursor c = myDb.rawQuery("Select MAX(ParkID) From CPark",null);
	if(c.moveToNext()){
		ID=c.getInt(0);
		if(ID==0){
			ID=1;
...
void saveData(int IDd,String BusIDd,String Srcd,String Destd,String UNd,String SeatNod,String Cityd) {
   ...
   dte = df.format(c.getTime());
	...
	long ret = myDb.insert("CPark", null, newValues);
	
	if (ret > 0){
			    			
		 Toast.makeText(PayCPark.this,"Car Parking Booked Successfully",Toast.LENGTH_LONG).show();
	}
	myDb.close();
}
}
