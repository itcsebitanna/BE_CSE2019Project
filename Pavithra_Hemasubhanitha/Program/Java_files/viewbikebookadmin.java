...
public class viewbikebookadmin extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.viewbikebooksadmin);
      		
      		 list1=(ListView) findViewById(R.id.listView2VSBDABP);
         ...
         void LoadData(){
             ...
             if(myDb != null) {
                 Cursor c = myDb.rawQuery("SELECT * from BPark Order by DT Desc",null);
                 if(c.moveToFirst())
                 {
                     do
                     {
