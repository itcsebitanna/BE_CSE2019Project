...
if(isset($btn))
{
$q1=mysql_query("select * from register where username='$cname'");
$n1=mysql_num_rows($q1);
	...
	$id=$max_row['maxid']+1;
		...
		$uqry="insert into contact(id,uname,cname) values($id,'$uname','$cname')";
...
$cid=$_POST['cid'];
	...
	foreach($cid as $cd)
	{
	mysql_query("delete from contact where id=$cd");
	}
header("location:contact.php");
}
    ...
    <tr>
      ...
      <td width="83%" align="center" valign="top"><p class="txt1">&nbsp;</p>
        ...
        <table width="200" border="1">
		  ...
		  <?php
		  $qry=mysql_query("select * from contact where uname='$uname'");
