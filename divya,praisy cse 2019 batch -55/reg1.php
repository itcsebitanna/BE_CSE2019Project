...
if(isset($res))
{
 ...
 if(trim($res=="")) { $msg = "Say Login or Register"; }
	else
	{
	//	echo "demo";
		
		$uname=strtolower($res);
			$max_qry = mysql_query("select max(id) maxid from register");
	$max_row = mysql_fetch_array($max_qry);
	$id=$max_row['maxid']+1;
	$rdate=date("d-m-Y");
	
		 $uqry=mysql_query("insert into register(id,name,gender,contact,username,password,rdate) values($id,'$uname','','0','','','$rdate')");
				header("location:reg2.php?id=".$id);
...
<form id="myForm" name="form1" method="post" action="">
  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      <td><?php include("include/link_home.php"); // onLoad="startButton(event)" // id="myForm" ?></td>
    </tr>
    <tr>
      <td align="center" valign="top"><p class="txt1">&nbsp;</p>
          ...
          <table width="318" height="169" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" class="txt1"><strong>Say your Name </strong></td>
            </tr>
            <tr>
              <td align="center" class="txt1"><input type="text" name="res" id="res" onChange="test()" >              </td>
            </tr>
            <tr>
              <td align="center" class="txt1"><input type="submit" name="btn" id="btn" value="Submit"></td>
            </tr>
          </table>
