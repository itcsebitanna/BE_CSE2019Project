...
$id=$_REQUEST['id'];
$q1=mysql_query("select * from sender where id='$id'");
    ...
    <tr>
      ...
      <td width="83%" align="center" valign="top"><p class="txt1">&nbsp;</p>
        ...
        <table width="708" border="0" cellpadding="5" cellspacing="0">
          ...
          <tr class="hd1">
            <td>To : <?php echo $r1['send_to']; ?>, Date/Time : <?php echo $r1['rdate']; ?></td>
          </tr>
          <tr class="hd1">
        ...
        <p class="txt1"><a href="sent.php">Back to Sent Box </a></p>
        <p></p>
      <p></p></td>
    </tr>
    <tr>
